$(document).ready(function () {
  ...
  var saveUserInput = function(event) {
    ...
    localStorage.setItem(timeBlock, userEventInput.value());
    userEventInput.text = userEventInput.value();
  }
  ...
  $("#hour-13 .description").value(localStorage.getItem("hour-13"));
  $("#hour-14 .description").value(localStorage.getItem("hour-14"));
  $("#hour-15 .description").value(localStorage.getItem("hour-15"));
  $("#hour-16 .description").value(localStorage.getItem("hour-16"));
  $("#hour-17 .description").value(localStorage.getItem("hour-17"));
